...
func defaultConfig() Configuration {
	return Configuration{
		...
		Database: Database{
			Dialect: "mysql",
			DSN:     "root:123456@tcp(127.0.0.1:3306)/javin_blog?charset=utf8mb4&parseTime=True&loc=Local",
		},
		Seo: Seo{
			Description: "冰箱太凉的博客,talk about golang,java and so on.",
			Author: Author{
				Name:  "wangsy",
...
func Generate() error {
	...
	return os.WriteFile("conf/conf.toml", data, os.ModePerm)
}
